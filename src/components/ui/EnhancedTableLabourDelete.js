...
const headCells = [
  ...
  { id: 'workhour', label: 'Workhour' },
  { id: 'phoneno', label: 'Phone No.' },
  { id: 'supervisor', label: 'Supervisor' },
  { id: 'supervisorno', label: 'Supervisor No.' },
  { id: 'date', label: 'Date' },
];
...
export default function EnhancedTableLabourDelete(props) {
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="center">{row.workhour}</TableCell>
                      <TableCell align="center">{row.phoneno}</TableCell>
                      <TableCell align="center">{row.supervisor}</TableCell>
                      <TableCell align="center">{row.supervisorno}</TableCell>
