...
const EnhancedTableToolbar = (props) => {
  ...
  const [alert, setAlert] = React.useState({open: false, color: "#FF3232", message: "The Labour deleted!"})
  ...
  return (
    ...
    >
      ...
      <Snackbar 
        ...
        action={<Button onClick={onUndo} style={{color: "#F5F5F5"}}>
            Undo
        </Button>}
...
export default function EnhancedTableWorksiteDelete(props) {
